"""
Django settings for demo_40734 project.
...
WSGI_APPLICATION = 'demo_40734.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_40734 API",
    "DESCRIPTION": "API documentation for demo_40734 App",
    "VERSION": "v1",
}
